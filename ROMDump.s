...
arg_skip:
    ...
    ori.b   #$20,d0                    ; 英字小文字化
    cmpi.b  #'c',d0                    ; 'c' かな？
    beq     option_CGROM               ; 'c' は CGROM.DAT
    cmpi.b  #'3',d0                    ; '3' かな？
    beq     option_ROM30               ; '3' は ROM30.DAT
    cmpi.b  #'i',d0                    ; 'i' かな？
    beq     option_IPLROM              ; 'i' は IPLROM.DAT
    cmpi.b  #'n',d0                    ; 'n' かな？
    beq     option_SCSIINROM           ; 'n' は SCSIINROM.DAT
    cmpi.b  #'x',d0                    ; 'x' かな？
    beq     option_SCSIEXROM           ; 'x' は SCSIEXROM.DAT
    cmpi.b  #'f',d0                    ; 'f' かな？
    beq     option_X68KROM             ; 'f' は X68KROM.DAT
    cmpi.b  #'a',d0                    ; 'a' かな？
    beq     option_all                 ; 'a' は 全ROM
...
BUSERROR_hook:
    ...
    lea.l   BUSERROR_resume(pc),a0     ; ベクタのフック先
    move.l  a0,$0008.w                 ; バスエラーのベクタフック
